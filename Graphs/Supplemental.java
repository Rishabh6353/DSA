...
public class Supplemental {
    ...
    //Q: Strongly connected Graphs - KosaRaju's algorithm'
    ...
    public static void KosaRaju(ArrayList<Edge> graph[], int V){
        ...
        //step-2 : transpose the graph, i.e. reverse the directions
        ...
        //step - 3 : perform dfs based on popped nodes from stack
        while(!s.isEmpty()){
            int curr = s.pop();
            if(!vis[curr]){
    ...
    //Q: Tarjan algo : find bridge in graph
    public static void dfs2(ArrayList<Edge>graph[], int curr, int par, int dt[], int low[],boolean vis[] ,int time){
        ...
        for (int i = 0; i < graph[curr].size(); i++) {
            ...
            if(neigh == par){
                ...
                dfs2(graph, neigh, curr, dt, low, vis, time);
